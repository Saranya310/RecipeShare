    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Please sign in to view your reviews</h1>
          <button
            onClick={() => router.push('/')}
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden md:flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>Your reviews collection</span>
              </div>
              <button
                onClick={() => router.push('/profile')}
                className="text-gray-700 hover:text-emerald-600 transition-colors px-3 py-2 rounded-lg hover:bg-emerald-50"
              >
                👤 Profile
              </button>
              <button
                onClick={() => router.push('/dashboard')}
                className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                📊 Dashboard
              </button>
            </div>
        ...
        <div className="relative text-center mb-16">
          ...
          <div className="relative bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-4">
              My <span className="bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">Reviews</span>
            </h1>
            <p className="text-gray-600 text-xl mb-6">Reviews you've written for recipes</p>
        ...
        {loading && (
          <div className="text-center py-16">
            <div className="relative">
              <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-6 animate-pulse">
                <span className="text-white text-2xl">⭐</span>
              </div>
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-yellow-600"></div>
            </div>
            <p className="mt-6 text-gray-600 text-lg">Loading your reviews...</p>
          </div>
        )}
        ...
        {!loading && reviews.length === 0 && (
          <div className="relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-16 shadow-2xl border border-white/20 text-center">
              ...
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Your Reviews Collection Awaits</h3>
              <p className="text-gray-600 mb-10 text-xl max-w-md mx-auto">Start exploring recipes and share your thoughts with the community!</p>
              <button
