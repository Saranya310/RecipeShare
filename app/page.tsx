      ...
      <main className="relative flex items-center justify-center min-h-screen py-20">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex items-center justify-center mb-12">
            ...
            <span className="ml-4 text-base text-gray-600 font-medium">Join thousands of home cooks worldwide</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <button 
              ...
              className="group relative bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white px-10 py-5 rounded-2xl text-lg font-bold hover:from-emerald-700 hover:via-teal-700 hover:to-cyan-700 transition-all duration-500 shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 hover:scale-105 active:scale-95 overflow-hidden"
            >
              <span className="relative z-10 flex items-center">
                Start Sharing
                <span className="ml-3 text-xl group-hover:animate-bounce">🚀</span>
              </span>
            ...
            <button 
              onClick={handleSignIn}
              className="group bg-white/80 backdrop-blur-sm text-gray-700 px-10 py-5 rounded-2xl text-lg font-bold hover:bg-white/90 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 border border-white/20"
            >
