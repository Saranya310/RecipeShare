    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-700">Loading reviews...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="relative py-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-600 max-w-2xl mx-auto">
            Community reviews and ratings for recipes
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        {reviews.length === 0 ? (
          <div className="text-center py-6">
            ...
            <p className="text-gray-500 mb-4 text-sm">Be the first to review a recipe!</p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                href="/dashboard"
                className="border-2 border-yellow-600 text-yellow-600 px-4 py-2 rounded-lg font-semibold hover:bg-yellow-600 hover:text-white transition-colors text-sm"
              >
                Back to Dashboard
              </a>
            </div>
                  ...
                  <div className="flex items-center">
                    <div className="w-6 h-6 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center">
                      <span className="text-white text-xs font-bold">
                        {review.profiles.username?.charAt(0) || review.profiles.full_name?.charAt(0) || 'U'}
                      </span>
                    </div>
