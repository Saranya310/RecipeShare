    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="relative mb-16">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-100/20 to-teal-100/20 rounded-3xl blur-3xl"></div>
          
          {/* Stats container */}
          <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Your Recipe Journey</h2>
              <p className="text-gray-600">Track your culinary creations and community engagement</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div 
                ...
                className="group relative bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-emerald-200 cursor-pointer overflow-hidden"
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span className="text-white text-2xl">📝</span>
                    </div>
                    <div className="text-right">
                      <div className="text-4xl font-bold text-emerald-700 mb-1 group-hover:text-emerald-800 transition-colors">
                        {loading ? '...' : userRecipes.length}
                      </div>
                      <div className="text-sm font-semibold text-emerald-600">Recipes</div>
                    </div>
                  </div>
                  <h3 className="font-bold text-gray-900 mb-2 group-hover:text-emerald-700 transition-colors">My Recipes</h3>
                  <p className="text-sm text-gray-600 group-hover:text-emerald-600 transition-colors">Your culinary creations</p>
                </div>
              </div>
              ...
              <div 
                ...
                className="group relative bg-gradient-to-br from-yellow-50 to-orange-100 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-yellow-200 cursor-pointer overflow-hidden"
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span className="text-white text-2xl">⭐</span>
                    </div>
                    <div className="text-right">
                  ...
                  <p className="text-sm text-gray-600 group-hover:text-yellow-600 transition-colors">Feedback on your recipes</p>
                </div>
              </div>
              ...
              <div 
                ...
                className="group relative bg-gradient-to-br from-pink-50 to-rose-100 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-pink-200 cursor-pointer overflow-hidden"
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span className="text-white text-2xl">❤️</span>
                    </div>
                    <div className="text-right">
                      <div className="text-4xl font-bold text-pink-700 mb-1 group-hover:text-pink-800 transition-colors">
                        {loading ? '...' : favoritesCount}
                      </div>
                      <div className="text-sm font-semibold text-pink-600">Favorites</div>
                    </div>
                  </div>
                  <h3 className="font-bold text-gray-900 mb-2 group-hover:text-pink-700 transition-colors">My Favorites</h3>
                  <p className="text-sm text-gray-600 group-hover:text-pink-600 transition-colors">Recipes you've saved</p>
                </div>
              </div>
              ...
              <div 
                ...
                className="group relative bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-blue-200 cursor-pointer overflow-hidden"
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span className="text-white text-2xl">💬</span>
                    </div>
                    <div className="text-right">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Create Recipe</h3>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Discover Recipes</h3>
              <p className="text-gray-600 mb-6 text-sm leading-relaxed">
